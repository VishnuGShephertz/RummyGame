...
//                    izone.sendAddUserResponse(user, WarpResponseResultCode.SUCCESS, "Auth failed on server");
//                }
//            }
//            in.close();
        }catch(Exception e){
            izone.sendAddUserResponse(user, WarpResponseResultCode.SUCCESS, "");
        }
    }
